...
// Let's define out own special functions that compare matrix sizes, can access an element, etc.
...
void Row_switch_d(const Matrix_d *__m, Index_d *__ind, size_t __r1, size_t __r2);
...
Matrix_d *runif_gen_d(int n, double a, double b, RNG_FN rng_fn);
...
void Row_switch_f(const Matrix_f *__m, Index_f *__ind, size_t __r1, size_t __r2);
...
Matrix_f *runif_f(int n, double a, double b);
Matrix_f *runif_gen_f(int n, double a, double b, RNG_FN rng_fn);
...
Matrix_f *Matrix_runif_f(size_t __m, size_t __n, double __a, double __b);
Matrix_f *Matrix_rnorm_f(size_t __m, size_t __n, double __mean, double __std);
...
void Row_switch_i(const Matrix_i *__m, Index_i *__ind, size_t __r1, size_t __r2);
...
Matrix_i *runif_i(int n, double a, double b);
Matrix_i *runif_gen_i(int n, double a, double b, RNG_FN rng_fn);
...
Matrix_i *Matrix_runif_i(size_t __m, size_t __n, double __a, double __b);
Matrix_i *Matrix_rnorm_i(size_t __m, size_t __n, double __mean, double __std);
