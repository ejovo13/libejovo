...
gcc -E -P matrix_b.h -I../../inc > matrix_b.i
...
START_LINE_B=$( grep -n -m1 "extern const double PI" matrix_b.i | cut -f1 -d:)
...
tail -n +$START_LINE_B matrix_b.i >> matrix_gen.h
...
echo "Start_line_b: $START_LINE_I"